...
// Completely disable console logging in production to prevent EPIPE crashes
// when running detached in Windows.
if (!isDev) {
  console.log = () => {};
  console.error = () => {};
  console.warn = () => {};
...
// Prevent EPIPE errors from crashing the app when running in background

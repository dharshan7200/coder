...
const modelCategories: ModelCategory[] = [
  {
    ...
    openaiModels: [
      ...
      },
      {
        ...
        description: "Groq's latest vision model"
      }
    ],
    geminiModels: [
      {
  ...
  },
  {
    ...
    openaiModels: [
      ...
      },
      {
        ...
        name: "GPT-OSS 120B",
        description: "Groq's fastest reasoning model"
      }
    ],
    geminiModels: [
      {
      ...
      >        
        ...
        <div className="space-y-4 py-4">
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <div className="flex flex-col">
                    <p className="font-medium text-white text-sm">OpenAI / Groq</p>
                    <p className="text-xs text-white/60">GPT-4 / Groq</p>
                  </div>
                </div>
              </div>
              <div
          ...
          <div className="space-y-2">
            ...
            {apiProvider === "openai" ? "OpenAI / Groq API Key" : 
            ...
            <p className="text-xs text-white/50">
              Your API key is stored locally and never sent to any server except {apiProvider === "openai" ? "OpenAI / Groq" : "Google"}
            </p>
              ...
              {apiProvider === "openai" ? (
                <>
                  <p className="text-xs text-white/60 mb-1">1. Create an account at <button 
                    ...
                    className="text-blue-400 hover:underline cursor-pointer">OpenAI</button> or <button 
                    onClick={() => openExternalLink('https://console.groq.com/')} 
                    className="text-blue-400 hover:underline cursor-pointer">Groq</button>
                  </p>
